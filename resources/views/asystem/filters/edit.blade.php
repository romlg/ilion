                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <form method="POST" action="{{ route('filter.update', $item->filter_id) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    @foreach ($item->materials as $key => $filterMaterial)
                                                ...
                                                <select name="material[]" class="form-control">
                                                    @foreach($materials As $material)
                                                        <option value="{{ $material->material_id }}"
                                                                ...
                                                                @if($filterMaterial->material_id == $material->material_id) {{ $materialId = $material->material_id }} selected @endif>
                                                            {{ $material->title }}
                                                        </option>
                                                    @endforeach>
                                                </select>
